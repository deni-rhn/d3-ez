...
var ganttChart = function() {
	...
	var initTimeDomain = function (data) {
		...
		*/
		// FIXME! Work out first and last date.
		timeDomainStart = new Date(2016, 5, 1);
		timeDomainEnd = new Date(2019, 12, 24);
	};

	var initAxis = function (data) {
		...
		var categoryNames = {
			"Out of Support"   : "OutOfSupport",
			"Limited Support" : "LimitedSupport",
			"In Support"      : "InSupport"
		};
	...
	function my(selection) {
		...
		selection.each(function(data) {
			...
			seriesGroup.selectAll(".bar")
				...
				.attr("fill", function(d) { return colorScale(d.categoryName); })
